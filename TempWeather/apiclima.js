...
async function buscarPrevisao() {
    ...
    try {
        ...
        const cormin = getCorMinMax(tempmin);
        const cormax = getCorMinMax(tempmax);
        ...
        document.getElementById("resultado").innerHTML = `
            ...
            <p class="minima">Min: <span style="color: ${cormin};">${Math.round(tempmin)}°C</span></p>
            <p class="maxima">Max: <span style="color: ${cormax};">${Math.round(tempmax)}°C</span></p>
        `;
        ...
        } else if (condicaoTraduzidaComEmoji === '☀️ Céu limpo') {
